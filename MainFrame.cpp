...
MainFrame::MainFrame(const wxString& title)
    ...
    wxButton* play = new wxButton(panel, ID_PLAY, "▶", wxDefaultPosition, wxSize(25, 25));
    wxButton* stop = new wxButton(panel, ID_STOP, "⏹", wxDefaultPosition, wxSize(25, 25));
    wxButton* previous = new wxButton(panel, ID_PREVIOUS, "⏮", wxDefaultPosition, wxSize(25, 25));
    wxButton* next = new wxButton(panel, ID_NEXT, "⏭", wxDefaultPosition, wxSize(25, 25));
    wxToggleButton* random = new wxToggleButton(panel, ID_SHUFFLE, "🔀", wxDefaultPosition, wxSize(25, 25));
    wxToggleButton* repeat = new wxToggleButton(panel, ID_REPEAT, "🔁", wxDefaultPosition, wxSize(25, 25));
        ...
        playerThread = new std::thread([this]() {
            do {
                ...
                if (playButton && selectedTrack != nullptr) {
                    if (playButton->GetLabel() == "▶") {
                        playButton->SetLabel("⏸");
                    }
                    else if (playButton->GetLabel() == "⏸") {
                        playButton->SetLabel("⏸");
                    }
                }
